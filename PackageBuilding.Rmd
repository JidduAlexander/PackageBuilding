...
- In this post I share many keyboard shortcuts for working on Windows. For a complete overview for Mac and Windows press 'Alt Shift K' (windows) or 'Option Shift K' (Mac) in RStudio or see the backside of the Rstudio IDE Cheat Sheet. This and the Package Development Cheat Sheet are two of many available on the [RStudio Cheat Sheet üage](https://www.rstudio.com/resources/cheatsheets/).
